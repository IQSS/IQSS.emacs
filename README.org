...
| Easier file/buffer/access          | Convenience        | icicles            | Installed, turned on                           |                          |
...
| Command hinting/completion         | Convenience        | Ista               | icicles                                        | Installed and turned on  |
...
**** Run python in emacs (anaconda-mode)
