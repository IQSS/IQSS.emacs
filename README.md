...
- [Discussion and implementation](#sec-2)
  ...
  - [Implementation](#sec-2-3)
    ...
    - [Convenience key maps (hydra)](#sec-2-3-13)
    - [Major modes configuration](#sec-2-3-14)
    - [Miscellaneous](#sec-2-3-15)


# Quick start<a id="orgheadline23"></a>
...
## Modified key bindings<a id="orgheadline7"></a>
...
### Hydra key maps<a id="orgheadline5"></a>
...
### Other key bindings<a id="orgheadline6"></a>
...
## Suggested external programs<a id="orgheadline22"></a>
...
### External program download and installation<a id="orgheadline11"></a>
...
### External program configuration and use<a id="orgheadline21"></a>
...
# Discussion and implementation<a id="orgheadline53"></a>

## What the world needs now&#x2026;<a id="orgheadline24"></a>
...
## Requirements<a id="orgheadline25"></a>
...
### Version check<a id="orgheadline27"></a>
...
### Visual tweaks<a id="orgheadline28"></a>
...
### Install useful packages<a id="orgheadline29"></a>
...
### Load theme<a id="orgheadline30"></a>
...
### Add custom lisp directory to load path<a id="orgheadline31"></a>
...
### Spell checking<a id="orgheadline32"></a>
...
### Minibuffer hints and completion<a id="orgheadline35"></a>
...
### Auto-complete configuration<a id="orgheadline36"></a>
...
### Outline-magic<a id="orgheadline38"></a>

I encourage you to use [org-mode](#orgheadline37) for note taking and outlining, but it can be convenient to treat arbitrary buffers as outlines. The outline-magic mode can help with that.
...
### Convenience key maps (hydra)<a id="orgheadline39"></a>
...
"
  ;; Cycle
  ("<tab>" outline-cycle)  ; cycle visibility
  ;; Hide
...
### Major modes configuration<a id="orgheadline50"></a>
...
### Miscellaneous<a id="orgheadline51"></a>
