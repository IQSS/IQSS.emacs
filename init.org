...
:END:
1) Make sure emacs >= version 25.1 is installed on your computer. See [[UsefullPrograms.html][this list of useful programs]] for installation instructions.
...
- C-RET :: Mapped to language specific line/selection/expression evaluation. Want to evaluate code from a script? "Control-Enter" should just work.
- C-S-RET :: Mapped to language specific buffer evaluation. Want to evaluate a script? "Control-Shift-Enter" should just work.
