...
The second most important keyboard shortcut is =C-g=. If Emacs starts doing something you don't want it to, press =C-g= to cancel. If it doesn't work, press =C-g= again.

Other commonly used key bindings are listed in the table below. Note that many of these keybindings are modeled after windows defaults, but often require you to press the =S= (shift) key as well.
...
| =C-S-n=   | Open new file             |                                                                         |
| =C-S-s=   | Save file                 |                                                                         |
| =C-S-o=   | Search for a file to open |                                                                         |
| =C-S-f=   | Find in file              | =C-s= (think "search") does the same thing.                             |
